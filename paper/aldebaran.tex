...
Observatory (BOAO) spanning the period from 2000.01 to 2013.92.  Combined with earlier observations \citep{hatzes1993}, we construct a full time series spanning more than two decades and attempt to fit this with a Keplerian model and a CARMA noise process.
...
\caption{New radial velocities of Aldebaran obtained by the Hertzsprung~SONG Telescope.}
\label{alldata}
\end{figure}
