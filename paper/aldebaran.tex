...
Ornstein-Uhlenbeck process.  \citet{Kelly2014} gives more details on CARMA
processes in an astronomical context, including formulae for $A_i$ as a function
of $\sigma$, $r_i$, and $b_j$, and shows how a state-space model of the solution
