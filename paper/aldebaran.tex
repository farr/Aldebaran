...
By jointly fitting a Keplerian for the planet with a CARMA model for the stellar oscillations, we obtain a precise estimate of both \numax and the planetary orbital parameters. The planetary parameters we obtain are similar to \citet{Hatzes2015}: period $P = 629.0^{+ 1.7}_{-2.1}$~d, eccentricity $e = 0.168^{+ 0.069}_{- 0.071}$; and radial velocity semi-amplitude $K = 127^{+ 15}_{- 14}$~m/s. 
