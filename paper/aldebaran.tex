...
power spectral density distributions and are insensitive to the window function.
...
Fortunately, this GP can be written as the solution of a class of stochastic
ordinary differential equations, the Continuous Auto-Regressive Moving Average
(CARMA) models, whose likelihoods can be evaluated in linear time. For problems
such as the damped driven harmonic oscillator, we therefore have access to these
...
making it a possible low-mass brown dwarf candidate.
