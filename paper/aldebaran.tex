...
\tablecolumns{3}
\tablecaption{\label{tab:parameters} The parameters in our model (see Eq.\ \eqref{eq:RV-model}).}
\tablehead{\colhead{Parameter} & \colhead{Prior} & \colhead{Description}}
\startdata
$\mu_j$ & Normal\tablenotemark{a} & The per-site RV offset. \\
\enddata
\tablenotetext{a}{The prior for $\mu_j$ is centered on the mean of the data from site $j$ and has standard deviation 10 times the standard deviation of the data.}
\end{deluxetable}
